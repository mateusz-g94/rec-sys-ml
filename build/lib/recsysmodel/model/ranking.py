        ...
        self.user_embeddings = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Embedding(
                    ...
                    config.model_config.model_params["ran"]["user_embedding_dim"],
                ),
            ]
        )
        ...
        self.movie_embeddings = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Embedding(
                    ...
                    config.model_config.model_params["ran"]["movie_embedding_dim"],
                ),
            ]
        )
...
class MovielensModel(tfrs.models.Model):
    def __init__(self, layer_sizes, unique_user_ids, unique_movie_titles):
        ...
        self.ranking_model: tf.keras.Model = RankingModel(
            layer_sizes, unique_user_ids, unique_movie_titles
        )
