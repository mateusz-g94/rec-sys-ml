        ...
        self.user_embedding = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Embedding(
                    ...
                    config.model_config.model_params["ret"]["user_embedding_dim"],
                ),
            ]
        )

    def call(self, inputs):
        return tf.concat([self.user_embedding(inputs)], axis=1)
    ...
    def __init__(self, unique_movie_titles, movies):
        ...
        self.title_embedding = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Embedding(
                    ...
                    config.model_config.model_params["ret"]["title_embedding_dim"],
                ),
            ]
        )
        ...
        self.title_text_embedding = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Embedding(
                    max_tokens,
                    config.model_config.model_params["ret"]["title_text_embedding_dim"],
                    mask_zero=True,
                ),
